// icon:mail-open-outline | Ionicons https://ionicons.com/ | Ionic Framework
import * as React from 'react'

function IconMailOpenOutline(props: Readonly<React.SVGProps<SVGSVGElement>>) {
  return (
...
export default IconMailOpenOutline
